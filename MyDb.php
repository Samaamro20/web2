...
///////////////////////////////////////////////delete advice - DONE
// teacher_id it's not Important in
// $sql = "delete from advices where id=$advice_id and teacher_id = '$id'";
 	public function deleteadvice($advice_id){
 		$sql = "delete from advices where id='$advice_id'";
 		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
 	}
///////////////////////////////////////////////Show advice by User Id - DONE
...
///////////////////////////////////////////////edit advice - DONE
// teacher_id it's not Important in
// $sql = "UPDATE `advices` SET adviceText=$text WHERE teacher_id='$id' and id='$id'";
 	public function editadvice($id,$text){
 		$sql = "UPDATE `advices` 
 				SET adviceText=$text 
...
//$sql= "DELETE FROM SoundRecords WHERE $record_id=$record_id and $user_id=$id";
 	public function deletesound($record_id,$id){
 		$sql= "DELETE FROM soundrecords WHERE id=$record_id and publisher_id=$id";
 		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
 	...
 	public function editsoundname($id,$name,$publisher_id){
 		$sql = "UPDATE `soundrecords` SET name ='$name' WHERE publisher_id=$publisher_id and id=$id";
		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
 	...
 	public function editsoundrate($id,$rate,$publisher_id){
 		$sql = "UPDATE `soundrecords` SET rate =$rate WHERE spublisher_id=$publisher_id and id=$id";
		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
...
//////////////////////////////////////////// fav
 	public function addfav($record_id,$id){
 		$sql= "INSERT INTO favourites (record_id,user_id) VALUES ($record_id,$id)";
 		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
 	...
 	public function deletefromfav($record_id,$id){
 	...
 	public function addexams($questions,$answers,$teacher_id){
 		$sql= "INSERT INTO exams (`questions`, `answers`, `teacher_id`) VALUES ($questions,$answers,$teacher_id)";
 		$conn = $this->connect(); 
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
	...
	// $id ?? 
 	public function getexamquestions($id_sound){
 		$conn = $this->connect();
...
///////////////////////////////////student solutions
 	...
 	///////////////////////////follows
 	public function addfollows($follower_id,$following_id){
...
/////////////////////////////////////enroll
 	public function addenroll($class_id,$student_id){
 		$sql= "INSERT INTO `enroll` (`class_id`, `student_id`) VALUES ('$class_id','$student_id')";
 		$conn = $this->connect();
 		$result = $conn->query($sql);
 		echo $conn->error;
 		return $result;
